...
def main():
    ...
    print("- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -")
    print("Welcome to the BasedBall Python Universal Terminal!")
    print("- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -")
    time.sleep(0.5)

    home_team = input("Enter the name of the home team: ")
    print("Home Team set as " + home_team + ".")
    away_team = input("Enter the name of the away team: ")
    print("Away Team set as " + away_team + ".")
    ...
    side = "top"
    time.sleep(1)
    print("Today the " + home_team + " are hosting the " + away_team + " at " + stadium + ".")
    time.sleep(2)
    print ("As usual, the " + away_team + " will be batting at the top of the inning.")
    time.sleep(2)
    print("Just got word we'll be going for " + str(num_innings) + " innings today.")
    time.sleep(2)
    if max_off == "yes":
        print("Experts expect this to be a fierce game.")
    else:
        print("Experts are expecting a calm game today.")
    time.sleep(2)
    ...
    for i in range(num_innings):
        ...
        time.sleep(1.5)
        print(" . . . . . . . . . . . . . . . . . . . . . . . . . .")
        print("The score is " + away_team + ": " + str(away_team_stat_totals[4]))
    ...
    print("Thank you for joining us today at " + stadium + " for this match between the " + home_team + " and the " + away_team + ".")
    print(" . . . . . . . . . . . . . . . . . . . . . . . . . .")
    time.sleep(3.5)
    print("The final score is " + away_team + ": " + str(away_team_stat_totals[4]))
    print(home_team + ": " + str(home_team_stat_totals[4]))
    print(" . . . . . . . . . . . . . . . . . . . . . . . . . .")
    time.sleep(3)
    ...
    print("")
    time.sleep(1.5)
    print("Thanks for using the BasedBall Python Universal Terminal!")
    print("")
